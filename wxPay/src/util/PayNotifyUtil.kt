...
object PayNotifyUtil {
    ...
    fun handleNotify(
        ...
        val notifyBean = ApiJson.clientApiJson.decodeFromString<PayNotifyBean>(parameters.body)
        ...
        return if (notifyBean.type == "TRANSACTION.SUCCESS") {
            ...
            val orderPayDetail = ApiJson.clientApiJson.decodeFromString<OrderPayDetail>(json)
