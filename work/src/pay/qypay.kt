...
abstract class QyPayApi: WxApi() {
     ...
     * */
    fun sendRedPack(body: Map<String, Any?>) = doPostRaw(SEND_RED_PACK,body)


    /**
     * 查询红包记录
     * */
    fun queryRedPack(mch_billno: String) = doPostRaw(QUERY_RED_PACK, mapOf("mch_billno" to mch_billno))


    /**
     * 向员工付款
     * */
    fun pay(body: Map<String, Any?>) = doPostRaw(PAY,body)
     ...
     * */
    fun queryPay(body: Map<String, Any?>) = doPostRaw(QUERY_PAY,body)
}