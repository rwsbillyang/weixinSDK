...
class WxWorkTextMsg(
    ...
    constructor(content: String, agentId: Int, touser: String?) :
            this(touser, null, null, MsgType.TEXT, agentId, TextContent(content))
}
...
class WxWorkImageMsg(
    ...
    constructor(mediaId: String, agentId: Int, touser: String?) :
            this(touser, null, null, MsgType.IMAGE, agentId, ImageContent(mediaId))
}
...
class WxWorkVoiceMsg(
    ...
    constructor(mediaId: String, agentId: Int, touser: String?) :
            this(touser, null, null, MsgType.VOICE, agentId, VoiceContent(mediaId))
}
...
class WxWorkVideoMsg(
    ...
    constructor(mediaId: String, agentId: Int, touser: String?, title: String? = null, description: String? = null) :
            this(touser, null, null, MsgType.VIDEO, agentId, VideoContent(mediaId, title, description))
}
