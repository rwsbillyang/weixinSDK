...
class WxWorkEventHandler : IWorkEventHandler, KoinComponent {
    ...
    override fun onSubscribeEvent(appId: String, agentId: Int?, e: WorkSubscribeEvent): ReBaseMSg? {
    ...
    //内建应用+第三方应用 会有重复通知
    override fun onUnsubscribeEvent(appId: String, agentId: Int?, e: WorkUnsubscribeEvent): ReBaseMSg? {
        val userId = e.fromUserName //FromUserName 成员UserID
        val corpId = e.toUserName //ToUserName	企业微信CorpID
        val agentIdInMsg = e.agentId
        val agentId_ = agentIdInMsg ?: agentId
    ...
    //内建应用：
    override fun onTagUpdateEvent(appId: String, agentId: Int?, e: WorkTagUpdateEvent): ReBaseMSg? {
    ...
    //内建应用：
    override fun onExternalGroupChatCreateEvent(appId: String, agentId: Int?, e: ExternalChatChangeEvent): ReBaseMSg? {
        log.info("onExternalGroupChatCreateEvent: Not yet implemented")
        return null
    }

    //内建应用：
    override fun onExternalGroupChatDelEvent(appId: String, agentId: Int?, e: ExternalChatChangeEvent): ReBaseMSg? {
        log.info("onExternalGroupChatDelEvent: Not yet implemented")
        return null
    }

    //内建应用：
    override fun onExternalGroupChatUpdateEvent(appId: String, agentId: Int?, e: ExternalChatUpdateEvent): ReBaseMSg? {
        log.info("onExternalGroupChatUpdateEvent: Not yet implemented")
        return null
    }


    override fun onApprovalStatusChangeEvent(
        appId: String,
        agentId: Int?,
        e: WorkApprovalStatusChangeEvent
    ): ReBaseMSg? {
        log.info("onApprovalStatusChangeEvent: Not yet implemented")
        return null
    }

    override fun onBatchJobResultEvent(appId: String, agentId: Int?, e: WorkBatchJobResultEvent): ReBaseMSg? {
        log.info("onBatchJobResultEvent: Not yet implemented")
        return null
    }

    override fun onEnterAgent(appId: String, agentId: Int?, e: WorkEnterAgent): ReBaseMSg? {
        log.info("onEnterAgent: Not yet implemented")
        return null
    }

    override fun onLocationEvent(appId: String, agentId: Int?, e: WorkLocationEvent): ReBaseMSg? {
        log.info("onLocationEvent: Not yet implemented")
        return null
    }

    override fun onMenuClickEvent(appId: String, agentId: Int?, e: WorkMenuClickEvent): ReBaseMSg? {
        log.info("onMenuClickEvent: Not yet implemented")
        return null
    }

    override fun onMenuLocationEvent(appId: String, agentId: Int?, e: WorkMenuLocationEvent): ReBaseMSg? {
        log.info("onMenuLocationEvent: Not yet implemented")
        return null
    }

    override fun onMenuPhotoEvent(appId: String, agentId: Int?, e: WorkMenuPhotoEvent): ReBaseMSg? {
        log.info("onMenuPhotoEvent: Not yet implemented")
        return null
    }

    override fun onMenuPhotoOrAlbumEvent(appId: String, agentId: Int?, e: WorkMenuPhotoOrAlbumEvent): ReBaseMSg? {
        log.info("onMenuPhotoOrAlbumEvent: Not yet implemented")
        return null
    }

    override fun onMenuScanCodePushEvent(appId: String, agentId: Int?, e: WorkMenuScanCodePushEvent): ReBaseMSg? {
        log.info("onMenuScanCodePushEvent: Not yet implemented")
        return null
    }

    override fun onMenuScanCodeWaitEvent(appId: String, agentId: Int?, e: WorkMenuScanCodeWaitEvent): ReBaseMSg? {
        log.info("onMenuScanCodeWaitEvent: Not yet implemented")
        return null
    }

    override fun onMenuViewEvent(appId: String, agentId: Int?, e: WorkMenuViewEvent): ReBaseMSg? {
        log.info("onMenuViewEvent: Not yet implemented")
        return null
    }

    override fun onMenuWorkAlbumEvent(appId: String, agentId: Int?, e: WorkMenuWorkAlbumEvent): ReBaseMSg? {
        log.info("onMenuWorkAlbumEvent: Not yet implemented")
        return null
    }


    override fun onTaskCardClickEvent(appId: String, agentId: Int?, e: WorkTaskCardClickEvent): ReBaseMSg? {
        log.info("onTaskCardClickEvent: Not yet implemented")
        return null
    }
